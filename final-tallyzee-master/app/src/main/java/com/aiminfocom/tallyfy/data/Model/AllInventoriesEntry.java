...
@Entity(tableName = "AllInventoriesEntry")
public class AllInventoriesEntry implements Serializable,Parcelable {
    ...
    protected AllInventoriesEntry(Parcel in) {
    ...
    public AllInventoriesEntry()
    {

    }

    public static final Creator<AllInventoriesEntry> CREATOR = new Creator<AllInventoriesEntry>() {
        @Override
        public AllInventoriesEntry createFromParcel(Parcel in) {
            return new AllInventoriesEntry(in);
        }

        @Override
        public AllInventoriesEntry[] newArray(int size) {
            return new AllInventoriesEntry[size];
        }
    };
    ...
    public AllInventoriesEntry(String stockItemName, String basicUserDesc, String rate, String amount, String edqty, String actualQty, List<BatchAllocation> batchAllocationList) {
        this.stockItemName = stockItemName;
        this.basicUserDesc = basicUserDesc;
        this.rate = rate;
        this.amount = amount;
