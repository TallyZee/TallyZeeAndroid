...
@Override
public PaymentAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new PaymentAdapter.DataViewHolder(LayoutInflater.from(parent.getContext())
        .inflate(R.layout.sales_layout_summary_fragment, parent, false));
        }

@Override
public void onBindViewHolder(PaymentAdapter.DataViewHolder holder, int position) {
