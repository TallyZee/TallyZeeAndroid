package com.aiminfocom.tallyfy.ui.DashBoardSpace.Fragments;
...
public class DatePickerFragment extends DialogFragment implements View.OnClickListener{
    ...
    public static DatePickerFragment newInstance(OnDateRangeSelectedListener callback, boolean is24HourMode) {
        DatePickerFragment dateRangePickerFragment = new DatePickerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.date_picker_range, container, false);
